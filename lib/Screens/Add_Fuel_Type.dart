                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(fuel_type_error==1?'You must enter a valid fuel type':'',style: TextStyle(color:Colors.red,fontSize:21),),
                        SizedBox(
                          height: 5,
                        ),
                        ...
                        SizedBox(
                         ...
                         Text(official_price_error==1?'You must enter a valid price':'',style: TextStyle(color:Colors.red,fontSize:21),),
                       SizedBox(
                          height: 5,
                        ),
                       ...
                       SizedBox(
                         ...
                         Text(profit_error==1?'You must enter a valid Profit':'',style: TextStyle(color:Colors.red,fontSize:21),),
                       SizedBox(
                          height: 5,
                        ),
